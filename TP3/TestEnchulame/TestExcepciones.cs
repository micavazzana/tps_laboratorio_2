...
namespace TestEnchulame
{
    ...
    {
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar escribir un archivo de texto cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        ...
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar leer un archivo de texto cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArchivoException))]
        ...
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar escribir un archivo xml cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArchivoException))]
        ...
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar escribir un archivo json cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArchivoException))]
        ...
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar leer un archivo xml cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArchivoException))]
        ...
        /// <summary>
        /// Test que retorna un Archivo Exception al intentar leer un archivo json cuando la ruta es invalida
        /// </summary>
        [TestMethod]
        [ExpectedException(typeof(ArchivoException))]
